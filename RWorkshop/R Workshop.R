...
# Use str() to obtain an overview of the data frame.
str(hflights) # By default, a column of text is treated as a factor.
...
library(data.table) # Very fast alternative to data.frame.
library(reshape2)
